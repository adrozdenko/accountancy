...
I want to be able register Income transaction
    ...
    Scenario Outline: I’m trying to register incorrect Income transaction
        ...
        | "1.45"      | 2          |  1              | 1           | "Account doesn’t exist"                       |
        | "2.44"      | 1          |  2              | 1           | "Counterparty doesn’t exist"                  |
        | "12.32"     | 1          |  1              | 3           | "Category doesn’t exist"                      |
        | "-12.32"    | 1          |  1              | 1           | "Amount of money should be greater than zero" |
